<?php
  ...
  if ($response['conexion']=='OK') { //Si la conexión es exitosa
    ...
    $email = "lensy@mail.com";
	  $nombre = "Lenys Rodriguez";
    $password = password_hash($defaultPassword, PASSWORD_DEFAULT); //Encriptar la contraseña
    ...
    $response['msg']= 'Información de inicio de sesion:</br>email:'; //Mostrar mensaje con la información de los usuarios guardados
